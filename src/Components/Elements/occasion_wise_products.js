...
function OccasionWiseProducts({ onParentData }) {
          ...
          {tagCategoriesData.map((value, index) => {
            if (value.tagProducts.length > 0) {
              if (value.tag_grid_type === 1) {
                return (
                  <section className="sec-pad pt-0" key={index}>
                    <div className="container" key={index}>
                      ...
                      <div className="row">
                        <p className="tag-meta-desc col-lg-6 col-md-8 col-sm-12 col-xs-12 col-xl-8">{value.tag_meta_desc}</p>
                      </div>
                      <div className="row">
                ...
                return (
                  <section className="sec-pad" key={index}>
                    <div className="container" key={index}>
                      <div className="section-title d-flex align-items-center justify-content-between mb-4">
                        <h2 className="mb-0 tag-title">Mood for all occasions</h2>
                        <a className="btn-tag-all" href={"/collection/cateogry/occasion"}>
                          All <i className="d-icon-arrow-right"></i>
                        </a>
                      </div>
                      <div className="row">
                        <p className="tag-meta-desc col-lg-6 col-md-8 col-sm-12 col-xs-12 col-xl-10">{value.tag_meta_desc}</p>
                      </div>
                      <Swiper {...productCarouselOptions}>
                        {/* {value.tagProducts.map((subvalue, indexProduct) => {
                          ...
                          return ( */}
                            <SwiperSlide key={0} style={{display : 'flex'}}>
                              <div className="product" key={1}>
                                <figure className="product-media">
                                  <img src="http://13.201.27.40/img/uploads/category/16992938104821.png" 
                                    // width={400}
                                    // height={150}
                                  />
                                </figure>
                                <div className="occasion-detail">
                                    Manifestation                                    
                                </div>
...
export default OccasionWiseProducts;
