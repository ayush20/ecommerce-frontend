...
function SpaceWiseProducts({ onParentData }) {
              ...
              if (value.tag_grid_type === 1) {
                return (
                  <section className="sec-pad pt-0" key={index}>
                    <div className="container" key={index}>
                      ...
                      <div className="row">
                        <p className="tag-meta-desc col-lg-6 col-md-10 col-sm-12 col-xs-12 col-xl-8">{value.tag_meta_desc}</p>
                      </div>
                      <div className="row">
                ...
                return (
                  <section className="sec-pad" key={index}>
                    <div className="container" key={index}>
                      <div className="section-title d-flex align-items-center justify-content-between mb-4">
                        <h2 className="mb-0 tag-title">Shop by space</h2>
...
export default SpaceWiseProducts;
