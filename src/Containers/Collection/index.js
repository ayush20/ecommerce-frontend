...
function Collection({onParentData}) {
  ...
  return (
    ...
    <Helmet>
        ...
        <meta name="description" itemprop="description" content={helmetData.description != null ? helmetData.description :"Momabatti"} />
        <meta name="keywords" content={helmetData.keywords ? helmetData.keywords:"Momabatti"} /> 
        <link rel="canonical" href={window.location.href} />
        <meta property="og:title" content={helmetData.title ? helmetData.title:"Momabatti"} />
        <meta property="og:image" content= {constant.FRONT_URL+helmetData.image}/>
        <meta property="og:url" content={window.location.href} />
        <meta property="og:description" content= {helmetData.description != null ?helmetData.description:"Momabatti"} />
        <meta name="twitter:url" content={window.location.href} />
        <meta name="twitter:title" content={helmetData.title? helmetData.title: "Momabatti"} />
        <meta name="twitter:description" content={helmetData.description != null ?helmetData.description:"Momabatti"} />
        <meta property="twitter:image" content= {constant.FRONT_URL+helmetData.image}/>
    </Helmet>
      <ToastContainer
